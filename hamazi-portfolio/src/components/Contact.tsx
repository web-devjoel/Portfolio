...
export default function Contact() {
  const socials = [
    { name: "GitHub", link: "https://github.com/web-devjoel", icon: "https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/github.svg" },
    ...
    <section id="contact" className="py-20 bg-[#1c1e2c] border-t border-gray-700">
      <FadeIn>
        ...
        <p className="text-gray-300 text-center mb-10">
          Have a project or idea in mind? Let's collaborate!
        </p>
          ...
          {socials.map((s, i) => (
            ...
            >
              <img
                src={s.icon}
                alt={s.name}
                className="w-9 h-9 filter brightness-90 hover:brightness-110"
              />
            </button>
          ))}
        </div>
