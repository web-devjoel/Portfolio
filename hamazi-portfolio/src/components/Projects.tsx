...
export default function Projects() {
  const projects: Project[] = [
    ...
    { title: "Hamazi's News", desc: "A clean, modern mini-news platform focused on global and political events.", link: "https://web-devjoel.github.io/News/" },
      ...
      <FadeIn>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col justify-center items-center bg-[#2a2d40] rounded-xl p-6">
            ...
            {/* GameFi P2E Arena Placeholder */}
            <div className="mt-6 text-center">
              <h4 className="text-red-500 text-xl font-semibold mb-3">GameFi P2E Arena</h4>
              <p className="text-gray-300">{`A blockchain-based Play-to-Earn battle arena game with token rewards.`}</p>
            </div>
          </div>
        </div>
      </FadeIn>
